![Shadowsocks](https://github.com/citizen010/shadowsocks/blob/master/img/shadowsocks.jpg)
...
> This guide is written for a non-root user. Commands that require elevated privileges are prefixed with `sudo`. If you’re not familiar with the `sudo` command, see the [Users and Groups](https://www.linode.com/docs/tools-reference/linux-users-and-groups/#understanding-sudo) guide.
...
3.	Launch the Shadowsocks-Qt5 from the application manager of your Linux system.
	...
	![Linux client configuration](https://github.com/citizen010/shadowsocks/blob/master/img/linux-client-shadowsocks-qt5.png "Linux client configuration")
...
4.	A new window will be opened for the connection manager, click to the `Add` and then choose `Manually` option to configure your connection settings.
	...
	![Linux client configuration](https://github.com/citizen010/shadowsocks/blob/master/img/linux-client-shadowsocks-conn.png "Linux client configuration")

5.	Edit your client profile under the new connection manager as shown below.

	![Linux client configuration](https://github.com/citizen010/shadowsocks/blob/master/img/linux-client-shadowsocks-conn2.png "Linux client configuration")
...
![Windows client configuration](https://github.com/citizen010/shadowsocks/blob/master/img/win-client-shadowsocks.png "Windows client configuration")
...
![Firefox proxy setting](https://github.com/citizen010/shadowsocks/blob/master/img/firefox-set-proxy.png "Firefox proxy setting")

3.	Next, under the Connection Settings, choose `Manual proxy configuration` and enter corresponding values as shown below.

![Firefox proxy setting](https://github.com/citizen010/shadowsocks/blob/master/img/firefox-manual-proxy.png "Firefox proxy setting")
